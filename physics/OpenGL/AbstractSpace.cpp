...
void	AbstractSpace::updateModifierKeys()
{
	m_modifierKeys = 0;
...
void AbstractSpace::specialKeyboard(int key, int x, int y)	
{
	(void)x;
	(void)y;
...
void AbstractSpace::swapBuffers()
{
	glutSwapBuffers();
...
void AbstractSpace::renderscene(int pass) {
}
