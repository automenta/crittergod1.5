...
void SpaceProcess::updateCamera() {

	//interpolate cameraPosition cameraPositionNext
	m_cameraPosition = (1.0 - cameraSpeed) * m_cameraPosition + (cameraSpeed) * m_cameraPositionNext;
	m_cameraTargetPosition= (1.0 - cameraSpeed) * m_cameraTargetPosition + (cameraSpeed) * m_cameraTargetPositionNext;
	...
	m_cameraRight = (m_cameraUp.cross(forward));
...
{ 
	...
	m_cameraTargetPositionNext+= m_cameraRight*0.1;
	updateCamera();
}
...
{ 
	...
	m_cameraTargetPositionNext+=rayForward;
